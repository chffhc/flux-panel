...
```bash
curl -L https://raw.githubusercontent.com/chffhc/flux-panel/673f74f/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
```
...
```bash
curl -L https://raw.githubusercontent.com/chffhc/flux-panel/673f74f/install.sh -o ./install.sh && chmod +x ./install.sh && ./install.sh
```
